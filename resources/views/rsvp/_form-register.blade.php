<form id="form-register" action="#" style="display:none;">
    ...
    <div class="form-group">
        <label for="form-register-email">Email Address<span class="form-required">*</span></label>
    ...
    <div class="form-group">
        <label for="form-register-password">Password<span class="form-required">*</span></label>
    ...
    <div class="form-group">
        <label for="form-register-password-confirm">Confirm Password<span class="form-required">*</span></label>
